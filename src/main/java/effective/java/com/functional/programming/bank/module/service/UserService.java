package effective.java.com.functional.programming.bank.module.service;
...
import effective.java.com.functional.programming.bank.module.util.UserUtils;
...
public class UserService {
    ...
    public List<User> getAdultUsersWithNotRepaidLoans(List<User> users){
        return users.stream()
                .filter(UserUtils::isAdult)
                .filter(user -> user.getLoans().stream()
                        .anyMatch(loan -> loan.getDue().after(new Date())))
                .collect(toList());
    }

    public List<User> getAdultBoysWithRepaidLoans(List<User> users){
        return users.stream()
                .filter(UserUtils::isAdult)
                .filter(UserUtils::isMale)
                .filter(user -> user.getLoans().stream()
                    .anyMatch(loan -> loan.getDue().before(new Date())))
                .collect(toList());
    }

    public Map<Bank, List<User>> groupUsersByBankWithRepaidLoans(List<User> users){
        return users.stream()
                .flatMap (user -> user.getLoans().stream()
    ...
    public Map<Bank, List<Loan>> groupRepaidLoansByBank(List<User> users){
        return users.stream()
    ...
    public List<String> getUniqueFemaleNamesWithRepaidLoans(List<User> users){
        return users.stream()
                .filter(UserUtils::isFemale)
    ...
    public Map<String, Double> getAverageLoanAmountForUserName(List<User> users){
        return users.stream()
                .collect(toMap(User::getName,
                    user -> user.getLoans().stream()
                            .mapToDouble(loan -> loan.getAmount().doubleValue())
                            .average()
                            .getAsDouble(), (a1, a2) -> a2));
    }

    public Map<String, List<Loan>> getThreeBiggestLoansAmountGroupedByUserName(List<User> users){
        return users.stream()
                .collect(toMap(User::getName,
                        user -> user.getLoans().stream()
    ...
    public List<User> createListOfRandomUsers(){
        ...
        Bank oshchad = new Bank(5L, "Oshchad Bank");
        ...
        loans1.add(new Loan(3L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 31).getTime(), new BigDecimal(4400), new BigDecimal(100), privat));
        ...
        loans3.add(new Loan(11L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 31).getTime(), new BigDecimal(400), new BigDecimal(342), privat));
        ...
        loans4.add(new Loan(16L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 31).getTime(), new BigDecimal(0), new BigDecimal(0), revolute));
        ...
        loans5.add(new Loan(19L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 31).getTime(), new BigDecimal(400), new BigDecimal(100), privat));
        ...
        loans7.add(new Loan(29L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 19).getTime(), new BigDecimal(0), new BigDecimal(0), revolute));
        ...
        loans8.add(new Loan(32L, new GregorianCalendar(2020, 1, 30).getTime(),
                new GregorianCalendar(2021, 11, 31).getTime(), new BigDecimal(4700), new BigDecimal(142), privat));
